...
CATEGORIES = {
    ...
    "🤖 Автомодератор": {
        ...
        "admin_only": True,
        "commands": [
            ("banword add / remove / list", "Керування фільтром заборонених слів"),
            ("whitelist add / remove / list", "Керування білим списком слів"),
    ...
    "💰 Економіка": {
        ...
        "commands": [
            ...
            ("playcontinue", "Відновити останній плейлист та час пісні"),
    ...
    "🎵 Музика": {
        ...
        "admin_only": False,
        "commands": [
            ("join / зайти", "Приєднатись до голосового каналу"),
            ("play / p / грати", "Відтворити пісню або додати в чергу"),
            ("skip / s / пропустити", "Пропустити поточну пісню"),
            ("pause / пауза", "Поставити на паузу"),
            ("resume / продовжити", "Продовжити відтворення"),
            ("volume / vol", "Змінити гучність (10-200)"),
            ("queue / q / черга", "Показати чергу"),
            ("cq / очерга", "Очистити чергу"),
            ("history / his / історія", "Останні 20 пісень (додати: !his 1,3)"),
            ("stop / зупинити / вийти", "Зупинити та вийти з каналу"),
        ]
    },
    "🎲 Ігри": {
        "emoji": "🎲",
        ...
        "admin_only": False,
        "commands": [
            ("coinflip", "Орел чи решка на ставку"),
            ("slots", "Ігрові автомати на ставку"),
        ]
    },
    "🎫 Тікети": {
        "emoji": "🎫",
